...
type stubConfigurationService struct {
	createFn func(context.Context, *model.Configuration) (uuid.UUID, error)
	getFn    func(context.Context, uuid.UUID) (*model.Configuration, error)
	updateFn func(context.Context, *model.Configuration) error
	deleteFn func(context.Context, uuid.UUID) error
	listFn   func(context.Context, service.ConfigurationListFilter) ([]model.Configuration, error)
}

func (s stubConfigurationService) Create(ctx context.Context, cfg *model.Configuration) (uuid.UUID, error) {
	return s.createFn(ctx, cfg)
}

func (s stubConfigurationService) Get(ctx context.Context, id uuid.UUID) (*model.Configuration, error) {
	return s.getFn(ctx, id)
}

func (s stubConfigurationService) Update(ctx context.Context, cfg *model.Configuration) error {
...
func (s stubConfigurationService) List(ctx context.Context, filter service.ConfigurationListFilter) ([]model.Configuration, error) {
...
func TestCreateConfigurationReturnsEnvelope(t *testing.T) {
	...
	handler := &ConfigurationHandler{
		svc: stubConfigurationService{
			createFn: func(_ context.Context, cfg *model.Configuration) (uuid.UUID, error) {
	...
	body := bytes.NewBufferString(`{"application_id":"11111111-1111-1111-1111-111111111111","name":"cfg","env":"staging"}`)
	...
	var payload struct {
		Data model.Configuration `json:"data"`
	}
...
func TestListConfigurationsReturnsEnvelope(t *testing.T) {
	...
	handler := &ConfigurationHandler{
		svc: stubConfigurationService{
			listFn: func(_ context.Context, filter service.ConfigurationListFilter) ([]model.Configuration, error) {
				if filter.Name != "" {
...
func TestUpdateConfigurationNotFoundReturnsErrorEnvelope(t *testing.T) {
	...
	handler := &ConfigurationHandler{
		svc: stubConfigurationService{
			updateFn: func(_ context.Context, _ *model.Configuration) error {
	...
	id := uuid.New()
	body := bytes.NewBufferString(`{"application_id":"11111111-1111-1111-1111-111111111111","name":"cfg","env":"staging","latest_revision_no":1}`)
